package com.game.Ticket_To_Flight.frontend.UI.screens.MainScreen.GameUIManagerDirectory.Airlines;
...
public class AirlinesControls {
    ...
    private TextButton createPassButton() {
        TextButton button = new TextButton("Pass", skin, "default");
    ...
    private TextButton createFinishButton() {
        TextButton button = new TextButton("Finish this stage", skin, "default");
        button.addListener(new ClickListener() {
            @Override
            public void clicked(InputEvent event, float x, float y) {
                finishAfterPurchase = true;
