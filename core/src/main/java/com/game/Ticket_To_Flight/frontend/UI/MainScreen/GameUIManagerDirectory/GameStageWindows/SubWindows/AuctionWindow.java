...
public class AuctionWindow extends BaseGameWindow {
    ...
    public AuctionWindow(Skin skin, final GameUIManager uiManager, final LowLevelHandlerFront llh, final GameData gameData) {
        ...
        if (leftVal <= rightVal) {
            ...
            subtitleLabel = new SingleLineText("Bet more to walk first in this round", skin);
            leftLabel = new SingleLineText(String.valueOf(leftVal), skin);
            rightLabel = new SingleLineText(String.valueOf(rightVal), skin);
            currentLabel = new SingleLineText(String.valueOf(leftVal), skin);
            ...
            betBtn = new RoundedButton("Bet", skin, "default");
            ...
            subtitleLabel = new SingleLineText("You have no money to go on", skin);
