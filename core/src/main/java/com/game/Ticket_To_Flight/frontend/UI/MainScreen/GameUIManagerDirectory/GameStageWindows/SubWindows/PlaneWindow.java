...
public class PlaneWindow extends BaseGameWindow {
    ...
    public PlaneWindow(Skin skin, final GameUIManager uiManager, final LowLevelHandlerFront llh, GameData gameData) {
        ...
        Label titleLabel = new SingleLineText("Plane purchase", skin);
        titleLabel.setFontScale(1.2f);
        this.add(titleLabel).padBottom(10).row();

        final Label choosePlaneTopLabel = new SingleLineText("Choose the plane", skin);
        ...
        while (it.hasNext()) {
            ...
            TextButton priceBtn = new RoundedButton("$" + plane.price, skin);
            priceBtn.setStyle(canAfford ? affordableStyle : expensiveStyle);
        ...
        final TextButton passBtn = new RoundedButton("Pass", skin, "red");
        final TextButton buyBtn = new RoundedButton("Buy the plane", skin, "default");
        final TextButton buyAndFinishBtn = new RoundedButton("Buy the plane and finish", skin, "red");
